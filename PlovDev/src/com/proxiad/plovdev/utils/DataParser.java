...
public class DataParser {
	...
	private static void parseData() {
		...
		LectureBean lec7 = new LectureBean(beginHour, endHour, name + " 7", description, speakerMark);
		LectureBean lec8 = new LectureBean(beginHour, endHour, name + " 8", description, speakerMark);
		...
		LectureBean lec11 = new LectureBean(beginHour, endHour, name + " 11", description, speakerMark);
		LectureBean lec12 = new LectureBean(beginHour, endHour, name + " 12", description, speakerMark);
		LectureBean lec13 = new LectureBean(beginHour, endHour, name + " 13", description, speakerMark);
		LectureBean lec14 = new LectureBean(beginHour, endHour, name + " 14", description, speakerMark);
